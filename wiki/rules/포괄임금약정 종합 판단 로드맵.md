...
provenance:
  ...
  external_links:
    ...
    - url: "https://www.moel.go.kr/news/enews/report/enewsView.do?news_seq=19208"
      ...
      note: ""
  evidence:
    - evidence_id: "evidence:rule-inclusive-wage-comprehensive-roadmap-ev-rule-inclusive-roadmap-formation"
    ...
    - evidence_id: "evidence:rule-inclusive-wage-comprehensive-roadmap-ev-rule-inclusive-roadmap-validity"
      ...
      verified_on: "2026-07-22"
    - evidence_id: "evidence:rule-inclusive-wage-comprehensive-roadmap-ev-rule-inclusive-roadmap-type-minimum"
      ...
      verified_on: "2026-07-22"
    - evidence_id: "evidence:rule-inclusive-wage-comprehensive-roadmap-ev-rule-inclusive-roadmap-current-mini"
      ...
      verified_on: "2026-07-22"
    - evidence_id: "evidence:rule-inclusive-wage-comprehensive-roadmap-ev-rule-inclusive-roadmap-recording"
      ...
      verified_on: "2026-07-22"
    - evidence_id: "evidence:rule-inclusive-wage-comprehensive-roadmap-ev-rule-inclusive-roadmap-guideline"
...
conflicts:
  - conflict_id: "conflict:rule-inclusive-wage-comprehensive-roadmap-legacy"
    type: "interpretive"
    status: "unresolvable"
    target_ids: []
    note: "대법원 판례에 따른 과거 약정의 사법상 성립·효력 판단과 2026년 고용노동부 지침에 따른 현재 임금구조의 행정상 시정은 질문과 효과가 다르므로 어느 하나로 병합하지 않고 병렬적으로 적용한다."
    resolved_on: null
    review_triggers:
      - "포괄임금약정의 성립·유효성·차액에 관한 대법원 판례 변경"
      - "최저임금 산입범위 또는 환산규정 변경"
...
먼저 근로자, 임금지급기와 청구기간을 확정한다. 전체 재직기간을 하나의 평균값으로 처리하지 말고 법령·최저임금·임금체계가 같은 기간별로 나눈다.
...
최저임금 미달 부분이 법정 최저임금으로 보충되어 통상임금 산정 기초가 달라지는 경우에는 보정된 통상시급으로 법정수당을 다시 계산한다. 최저임금 차액을 더하는 데서 끝내면 연장·야간·휴일수당의 연쇄 차액을 빠뜨릴 수 있다. ^claim-rule-inclusive-roadmap-recalculation
...
이 문서는 각 세부 Rule을 대체하지 않는다. 사건의 판단 순서와 분기 결과를 통제하는 상위 절차 Rule이며, 구체적 산식·판례 요건·법령상 예외는 연결 문서에서 확인한다.
